...
class TambahPostActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        when {
            imageUri == null -> Toast.makeText(this, "Please Seleect Image", Toast.LENGTH_SHORT)
                .show()
            TextUtils.isEmpty(deskripsi_post.text.toString()) -> Toast.makeText(this, "Please Write Caption",
                ...
                val fileRef =
                    storagePostPictureRef!!.child(System.currentTimeMillis().toString() + "Posts")
