...
import com.adnanamhar.instagram.adapter.CommentAdapter
import com.adnanamhar.instagram.model.Comment
...
class CommentActivity : AppCompatActivity() {
    ...
    private var commentAdapater: CommentAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commentAdapater = CommentAdapter(this, commentList as ArrayList<Comment>)
        recyclerView.adapter = commentAdapater
        ...
        txtpost_comments.setOnClickListener{
            if (add_comment!!.text.toString() == "") {
                Toast.makeText(this@CommentActivity, "Please Write Comment First", Toast.LENGTH_SHORT).show()
            } else {
