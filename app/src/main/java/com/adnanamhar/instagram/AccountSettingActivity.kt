package com.adnanamhar.instagram
...
import com.adnanamhar.instagram.model.User
...
//             create method untuk upload image profile
    ...
    private fun uploadImageAndUpdateInfo() {
        when {
            ...
            TextUtils.isEmpty(fullname_setprofile_editttext.text.toString()) -> {
                Toast.makeText(this,"Please Don't be Empty",Toast.LENGTH_SHORT).show()
            }
            username_setprofile_editttext.text.toString() == "" -> {
                Toast.makeText(this,"Please Don't be Empty",Toast.LENGTH_SHORT).show()
            }
            bio_setprofile_editttext.text.toString() == "" -> {
                Toast.makeText(this, "Please Don't be Empty", Toast.LENGTH_SHORT).show()
            }
            else -> {
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>> { task ->
                    ...
                    if (task.isSuccessful) {
                        ...
                        userMap["fullname"] = fullname_setprofile_editttext.text.toString().toLowerCase()
                        userMap["username"] = username_setprofile_editttext.text.toString().toLowerCase()
                        userMap["bio"] = bio_setprofile_editttext.text.toString().toLowerCase()
                        userMap["image"] = myUrl
        ...
        userRef.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if (p0.exists()) {
                    ...
                    username_setprofile_editttext.setText(user.getUsername())
                    fullname_setprofile_editttext.setText(user.getFullname())
                    bio_setprofile_editttext.setText(user.getBio())
                }
            }
        })
